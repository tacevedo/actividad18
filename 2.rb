...
def before_date(cursos, fecha = Date.today)
  cursos_filter = []
  # >= 2018-01-01.
  raise ArgumentError.new("Fecha inválida, debe ser menor a: 2019-01-01.") if fecha >= Date.parse("2019-01-01")
...
def after_date(cursos, fecha = Date.today)
  raise ArgumentError.new("Fecha inválida, debe ser mayor a: 2019-01-01.") if fecha >= Date.parse("2019-01-01")
  cursos_filter = []
  cursos.each do |curso|
